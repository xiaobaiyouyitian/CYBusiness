...
addhtmlfile.writeline("<tr><td align=""right""><a href=""../../"">返回首页</a> | 阅读 <font color=""red""><script src=""../../count.asp?id="&listid&"""></script></font> 次 | <a href=""../../reply.asp?upid="&upid&""">回复主题</a> | <a href=""../../modify.asp?id="&listid&""">作者编辑</a> | <a href=""javascript:window.close()"">关闭本页</a><hr align=""right"" width=""338"" size=""0"" color=""#B7DFF2""></td></tr>")
...
message="<li>回复主题成功</li><br><br><li><a href=../bbs>返回论坛首页</a></li>"
...
<form name="FORM" action="<%=myfilename%>" method="post" onsubmit="if(this.name.value==''){alert('请填写用户名');return false}else{if(this.pass.value==''){alert('请填写密码');return false}else{if(this.txttitle.value==''){alert('请填写标题');return false}else{if(this.content.value==''){alert('请输入内容');return false}}}}">
	...
	<table border="0" width="960" cellspacing="1" cellpadding="3" bgcolor="#43ABDE" align="center">
		<tr>
		<td colspan="3" class="list"><a href="../bbs">返回首页</a> -> 回复主题</td>
		</tr>
		<tr>
